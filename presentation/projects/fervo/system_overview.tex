...
\begin{frame}{System configuration}
  \begin{itemize}
    ...
    \item Generation is build out in $300MW$ steps and is defined by the water availability \\ $\Rightarrow$ Staged buildout of the transmission system is beneficial
