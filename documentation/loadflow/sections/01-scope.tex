...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item \textbf{DC voltage is regulated at the rectifier DC terminals.} The
        nominal dc voltage $U_{dpe,rec}$ is defined at the sending station and
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/bip-notation.pdf}
...
\begin{table}[!ht]
  ...
  \begin{tabularx}{\linewidth}{@{}l l X@{}}
    ...
    \midrule
    $P_{ac,inv}$   & MW            & AC power at the receiving end (inverter AC terminals) --- \emph{given} \\
    ...
    $U_{dpe,rec}$  & kV            & DC pole-to-ground voltage at the rectifier --- \emph{given} \\
    $U_{dpe,inv}$  & kV            & DC pole-to-ground voltage at the inverter \\
    ...
    $U_{dpm,inv}$  & kV            & DC pole-to-DMR voltage at the inverter (one pole out) \\
    ...
    $L$            & mi            & DC line length \\
    $r'_{d,hv}$      & $\Omega$/1000\,ft & Specific resistance of one HV subconductor \\
    $n_{hv}$       & ---           & Subconductors per pole (bundle count) \\
    $R_{d,hv}$     & $\Omega$      & Resistance of one pole conductor over the whole length \\
    $r'_{d,dmr}$     & $\Omega$/1000\,ft & Specific resistance of one DMR subconductor \\
    $n_{dmr}$      & ---           & Subconductors in the DMR bundle \\
    $R_{d,dmr}$    & $\Omega$      & Resistance of the DMR over the whole length \\
    $I_{d,dmr}$    & kA            & Current in the DMR; zero when the bipole is balanced \\
