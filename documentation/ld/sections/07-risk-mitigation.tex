...
\begin{enumerate}\setlength{\itemsep}{0.3em}
  ...
  \item \textbf{Set LDs high enough to change behaviour.} If the penalty is too
        low it becomes more convenient for the OEM to pay out and deprioritise
        American Terawatt's project in favour of higher-penalty contracts. The
        purpose of the LD is to \emph{incentivise the OEM to fix problems}.
  \item \textbf{Do not expect full recovery.} LDs will not recover the true
        commercial loss from unavailability; they are a behavioural lever, and
