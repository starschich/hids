...
\begin{itemize}
  \item \textbf{Guaranteed values (realistic, OEM-backable):} FEU $\approx$
        0.5\,\%, SEU $\approx$ 1\,\%, and a pole forced-outage of order 2-3 per year. 
        Bipolar forced-outage rate is of order 1 per 10 years. Very aggressive figures (e.g.\ 1 bipolar outages per 20 years) are
  ...
  \item \textbf{LD design principles:} LDs should be expressed as a percentage
        of OEM supply value, set high enough to \emph{incentivize the OEM to
        fix problems}, and understood as a behavioral lever rather than full
        recovery of loss.
\end{itemize}
...
PPA liability rather than defaulting to the typical 3--5\,\%.
