...
\begin{itemize}\setlength{\itemsep}{0.25em}
  ...
  \item \textbf{Shared corridor.} Spacing alone is not sufficient: as long as
        ...
        out a parallel circuit hundreds of meters --- even a mile --- away
        through smoke/pollution flashover; a severe weather event through a shared corridor
...
\begin{itemize}\setlength{\itemsep}{0.25em}
  ...
  \item \textbf{Better approach.} Retain \emph{access} to skilled personnel with
        a plan to mobilize them quickly to the site, and/or an OEM service-level
